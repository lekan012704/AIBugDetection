    ...
    public static class DependencyInjection
    {
            ...
            this IServiceCollection services)
        {
            services.AddHttpClient<IGenericHttpClientHandlerService, GenericHttpClientHandlerService>(client =>
            {
                ...
                //client.BaseAddress = new Uri("https://api.example.com/"); // Replace with your API base address
            });
            services.AddTransient<IGenericHttpClientHandlerService, GenericHttpClientHandlerService>();
